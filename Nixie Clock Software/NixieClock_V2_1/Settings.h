...
extern int AmountOfTimeToDisplayTime;  //interval between switch time -> date
extern int AmountOfTimeToDisplayDate;  //interval between switch date -> time
extern int ESPUpdateInterval; //interval between checking if ESP has updates available
extern int DateTimeUpdateInterval; //interval to reset the TimeUpdated & DateUpdated
